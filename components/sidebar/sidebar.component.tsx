                    ...
                    <ul className="mt-12">
                        ...
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" width={18} height={18} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                ...
                                <span className="text-sm  ml-2">Listings</span>
                            </div>
                        </li>
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm  ml-2">Trade history</span>
                            </div>
                        </li>
                        {/* If user is admin display additional links */}
                            ...
                            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" width={18} height={18} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                    ...
                                    <span className="text-sm  ml-2">Manage Users</span>
                                </div>
                            </li>
                            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                                <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" width={18} height={18} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                    ...
                                    <span className="text-sm  ml-2">Manage Listings</span>
                                </div>
                            </li>
                            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                                <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" width={18} height={18} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                    ...
                                    <span className="text-sm  ml-2">Add categories</span>
                                </div>
                            </li>
